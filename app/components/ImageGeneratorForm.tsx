...
export default function ImageGeneratorForm() {
  ...
  async function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      detected = true; // fail open — don't block if TF.js errors
    }
  ...
  async function submit(forceProceed = false, noImage = false) {
    ...
    try {
      ...
      const providerSec = json.latency_ms
        ...
        : "—";
      addToast(`Done — ${(totalElapsedMs / 1000).toFixed(1)}s total, ${providerSec} provider`, "success");
    } catch (err) {
      ...
      <div className="min-h-screen bg-slate-100 flex flex-col">
        ...
        <div className="flex-1 flex flex-col gap-3 p-4 pb-10 max-w-lg mx-auto w-full">
          ...
          <div className="relative w-full aspect-square rounded-2xl overflow-hidden bg-slate-900 shadow-md">
            ...
            {!displayUrl && (
              <label className="absolute inset-0 flex flex-col items-center justify-center gap-3 cursor-pointer select-none">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 flex flex-col gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. beloved family companion"
              ...
              />
              {captionError && (
                <p className="mt-1 text-xs text-red-600">{captionError}</p>
              )}
            </div>
